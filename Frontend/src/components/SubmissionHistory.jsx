              ...
              <tbody>
                {submissions.map((sub, index) => (
                  ...
                  <tr key={sub._id}>
                    ...
                    <td className="font-mono">{sub.runTime*1000}ms</td>
                    <td className="font-mono">{formatMemory(sub.memory)}</td>
                    {/* <td className="font-mono">{sub.passedTestCases}/{sub.totalTestCases}</td> */}
            ...
            <div className="mb-4">
              <div className="flex flex-wrap gap-2 mb-2">
                ...
                <span className="badge badge-outline">
                  Runtime: {selectedSubmission.runTime*1000}ms
                </span>
                <span className="badge badge-outline">
